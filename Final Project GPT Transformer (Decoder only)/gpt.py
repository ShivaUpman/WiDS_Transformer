...
max_iters = 5000       # Training duration (Required: 3000-5000)
...
# --- 1. Automatic Data Download (Handles missing file) ---
file_path = 'input.txt'
...
# --- 2. Transformer Components (Required Blocks) ---
...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # Masking (Decoder property: can't see future)
...
print("\n--- Starting Training (Target: Val Loss < 2.0) ---")
